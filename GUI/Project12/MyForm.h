...
#pragma endregion
	...
	private:System::Void PopulateDataGridView()
	{
		...
		// Sample data vectors
		std::vector<std::string> column1Data = { "Data 1", "Data 2", "Data 3", "Value X", "Value Y", "Value Z" };
		std::vector<std::string> column2Data = { "Data A", "Data B", "Data C", "Value X", "Value Y", "Value Z" };
		std::vector<std::string> column3Data = { "Value X", "Value Y", "Value Z", "Value X", "Value Y", "Value Z" };
		...
		for (size_t i = 0; i < row_SIZE; i++)
		{
			...
			row->Cells[0]->Value = gcnew System::String(column1Data[0].c_str());
