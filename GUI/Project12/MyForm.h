...
namespace Project12 {
	...
	public:
		MyForm() // MAIN FUNCTION 
		{
			...
			//Display large texts in pre-build pages 
			// I added those txt files in the project folder
			DisplayText("label50.txt", label50); // high gaming
			DisplayText("label51.txt", label51); // mid gaming
			DisplayText("label52.txt", label52); // low gaming
			DisplayText("label53.txt", label53); // mid edit
			DisplayText("label54.txt", label54); // low edit
			DisplayText("label55.txt", label55); // high edit
			DisplayText("label60.txt", label60); // low office
			DisplayText("label61.txt", label61); //high office
			DisplayText("label59.txt", label59); //mid office
		}
...
#pragma region Windows Form Designer generated code
		...
		// 1 - MAIN MENU        2 - PC PARTS LIST		4 - GPU         6 - MOTHERBOARD         8 - COOLER    10 - CASE    13- GAMING PRESETS    15- OFFICE PRESETS
		// 11 - PRE BUILDS		 3 - CPU				        5 - RAM		   7 - STORAGE				   9 - PSU 	       12 - FINAL    14 -EDITING PRESETS          16 - CREDIT CART INFO
#pragma endregion
	...
	private:System::Void AddDataGridView(DataGridView^ dataGridView1, std::vector<std::vector<std::string>> Data)
	{
		...
		for (int i = 0; i < Data.size(); i++)
		{
			...
			// Now fill in the cells with values from Data
			for (int j = 0; j < Data[i].size() && j < dataGridView1->Columns->Count; j++)
			{
	...
	private:System::Boolean Compatibility() {   // FUNCTION TO CHECK IF SELECTED COMPONENTS ARE COMPATIBLE 
		...
		{
			String^ socket = "Your Selected Motherboard and CPU are incompatible";
		...
		//Ryzen 7000 Ram compatibility check
		if ((selectedMobo.getChipset() == "X670" || selectedMobo.getChipset() == "B650" || selectedMobo.getChipset() == "A620") && !selectedRAM.getDDR5())
		{
			String^ Ramissue = "This Ram is Incompatible with your selected Motherboard, You need DDR5";
			MessageBox::Show(Ramissue, "Incompatibility Error", MessageBoxButtons::OK, MessageBoxIcon::Error);
			return false;

		}
		//Ryzen 5000 Ram compatiblility check
		if ((selectedMobo.getChipset() == "B550" || selectedMobo.getChipset() == "A520") && (selectedRAM.getDDR5()))
		{
			String^ Ramissue = "This Ram is Incompatible with your selected Motherboard, You need DDR4";
			MessageBox::Show(Ramissue, "Incompatibility Error", MessageBoxButtons::OK, MessageBoxIcon::Error);
			return false;
		}
		//Intel 13/14 Ram compatiblility check
		if ((selectedMobo.getChipset() == "Z790" || selectedMobo.getChipset() == "B760") && !selectedRAM.getDDR5())
		{
			String^ Ramissue = "This Ram is Incompatible with your selected Motherboard, You need DDR5";
			MessageBox::Show(Ramissue, "Incompatibility Error", MessageBoxButtons::OK, MessageBoxIcon::Error);
			return false;
		}
		//Intel 12 Ram compatibility check
		if ((selectedMobo.getChipset() == "B660" || selectedMobo.getChipset() == "H610") && selectedRAM.getDDR5())
		{
			String^ Ramissue = "This Ram is Incompatible with your selected Motherboard, You need DDR4";
			MessageBox::Show(Ramissue, "Incompatibility Error", MessageBoxButtons::OK, MessageBoxIcon::Error);
			return false;
		}
		//Checks if the motherboard is compatible with the case
		...
		if ((selectedCase.getSize() == "ATX") && (selectedPSU.getSize() != "ATX"))
		{
			String^ psusize = "This Power Supply is incorrectly sized for your selected Case";
			MessageBox::Show(psusize, "Incompatibility Error", MessageBoxButtons::OK, MessageBoxIcon::Error);
			return false;
		}
	...
	private: System::Void button28_Click(System::Object^ sender, System::EventArgs^ e) { // LOW BUDGET GAMING
		...
		CartGrid->Rows[0]->Cells[3]->Value = RAMGrid->Rows[13]->Cells[0]->Value;
	...
	private: System::Void button29_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		CartGrid->Rows[0]->Cells[2]->Value = GPUGrid->Rows[16]->Cells[0]->Value;
		CartGrid->Rows[0]->Cells[3]->Value = RAMGrid->Rows[11]->Cells[0]->Value;
	...
	private: System::Void button38_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		selectedCooler = Coolers[23];
		selectedPSU = psu[0];
		selectedCase = cases[8];

		displayTotal();
	}


		   void DisplayText(String^ filePath, Label^ label1)
		   {
	...
	private: System::Void button39_Click(System::Object^ sender, System::EventArgs^ e) {
		//To save credit card info in a text box >:D
		String^ content = Environment::NewLine + "Card Holder Name: " + textBox2->Text + Environment::NewLine + "Card Number: " +
			textBox3->Text + Environment::NewLine + "Expiration Date: " + textBox4->Text + "         CVV:" + textBox5->Text;
		String^ filePath = "CreditCardInfo.txt";
